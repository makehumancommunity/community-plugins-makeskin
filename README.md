...
| [emissiveColor](docs/emissiveColor.md)                    | YES                     | YES                | -              | What light (if any) is emitted by the material.            |
| [ambientColor](docs/ambientColor.md)                      | -                       | -                  | ?              | Color used for simulating ambient light. This is not supported by nodes materials            |
| [viewPortColor](docs/viewPortColor.md)                    | YES                     | YES                | -              | What color to use for material when displaying object in viewport            |
| [diffuseTexture](docs/diffuseTexture.md)                  | YES                     | YES                | YES            | The image file used for diffuse color texturing. This also uses the texture's alpha channel to map for transparency.            |
| [bumpmapTexture](docs/bumpmapTexture.md)                  | YES                     | YES                | -              | The image file used for bump mapping. No shaders in MH are able to represent this visually.            |
| [normalmapTexture](docs/normalmapTexture.md)              | YES                     | YES                | YES            | The image file used for normal mapping.            |
| [displacementmapTexture](docs/displacementmapTexture.md)  | YES                     | YES                | -              | The image file used for displacement mapping.             |
| [specularmapTexture](docs/specularmapTexture.md)          | -                       | -                  | ?              | (It'll have to be further investigated what this does, if anything)            |
